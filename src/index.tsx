...
declare const AddEventForm: {};

export default AddEventForm;

export const AddEventComponents: React.FunctionComponent = () => {
    ...
    */
    ...
    const renderDateForm = (stateSetter: any, displaySetter: any) => {
                ...
                <ScrollView style={{ flex: 1, paddingHorizontal: 20, paddingVertical: 12 }}>
                    ...
                    <View style={{ flex: 1, marginBottom: 12 }}>
                        ...
                        <View style={{ flex: 1, flexDirection: 'row' }}>
                            ...
                            {displayStartDateForm && renderDateForm(setStartDate, setDisplayStartDateForm)}
